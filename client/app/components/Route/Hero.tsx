   ...
   <>
   {
    isLoading ? (
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <br />
        <br />
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] relative">
          <div className="flex justify-end mb-4">
            <h1 className="font-extrabold text-[#45CBA0] text-[50px] 1000px:text-[50px] tracking-wide">Improve your learning experience Better Instantly</h1>
          </div>
          <div className="h-[50px] bg-transparent relative">
            <input
              type="search"
